...
//This function is for plading an x(batman) or o(superman) in a square.
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'URL("images/batman1_resize.png")';
            //Active player may only be 'X' or 'O' so, in fot 'X' it must be 'O'
        } else {
            //If active player is equal to 'O', the o.png is placed in HTML.
            select.style.backgroundImage = 'URL("images/superman_resize.png")';
        }
        ...
        if(activePlayer === 'O') {
            //This function disables clicking for comupter choice.
            disableClick();
            //This function wiats 1 second before computer places image and enables click.
    ...
    function computersTurn() {
        ...
        while(!success){
            ...
            //If the random number evaluated returns true, the square hasn't been selelcted yet.
...
//This line accesses our html canvas element
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        //This method moves us to ta starting point for our line.
        c.moveTo(x1, y1)
